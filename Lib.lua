...
local Success, Response = pcall(function()
	Icons = HttpService:JSONDecode(game:HttpGetAsync("https://raw.githubusercontent.com/Cndadd/Orn/main/IconLib.json")).icons
end)
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if OrionLib.Flags[a] then
			...
			warn("Fate Hub Config Loader - Could not find ", a ,b)
		end
	end)
end
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Fate Hub"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Fate Hub"
